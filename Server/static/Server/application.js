...
function addRowToTableWithFriends (viewerUserIdNumber, cellUserIdNumber, photo, first_name, last_name) {
    ...
    $('#main-table').append("<tr class='item'>" +
        ...
        "<td class='vert-align'>" + "<button type='button' class='button-date btn btn-xs btn-default' id=" + idDateString + ' value=' + valueDateString + '>' + "<i class='fa fa-heart-o fa-2x'></i>"+ '</button>' + '</td>' +
